...
- smuggling operation, moving things from the city 
	- need info about the operation, particularly one artefact stolen from [[Baldurs Gate]], solid gold [[Dragon Face Mask]]
	- ship called the loone
- or trip into the woods, group of drow running slaving operation, near an entrance to the [[Underdark]]
	- need the wiped out and a noble woman returned
	- noble woman is [[Alsacia Blaggard]], disappeared on the way to someone else's wedding, brother was killed
	- family asked to produce absurd ransom, but cannot
	- abductions have happened on the road for while but not someone so important before
- nat 20 [[Lazarus Illondris-Maladomini|Lazarus]] - [[Dragon Face Mask]] is from that of an old cult of [[Tiamat]], mask is unlikely to be magical, followers of dragon cults tend to get obsessed with
- [[Azane]] gets fake eyebrows, fireproof
- winged [[Zhentarim]] snake following us, [[Kotash]] tries to do a dance to charm it, weirdly swaps between sexy and formal
- [[Kotash]] suggestion on snake to leave us alone
- [[Dark Forest]] gets darker and more spider webby as we go deeper into the woods
- standard ambush, tree knocked over, drow arrows with spider silk
- +1 light crossbow, drowcraft, falls apart if exposed to sunlight
